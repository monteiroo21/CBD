...
public class ServiceSystemA {
    ...
    private static void addProduct(String username, String product) {
        ...
        if (jedis.zcard(username) >= PRODUCTS) {
            ...
            Integer timeLeft = ((Integer.parseInt(jedis.hget(TIMESTAMPS, username)) + TIMESLOT) - time);
    ...
    public static void main( String[] args ) throws Exception {
        ...
        while (true) {
            System.out.println("Enter the username ('Enter' to quit): ");
            String username = sc.nextLine();
            if (username.isEmpty()) {
                break;
            }

            System.out.println("Enter the product ('Enter' to quit): ");
